...
import { findPwd } from "../query/query";
import { mobileAuth, mobileCert } from "../query/query";
...
export default function PwdRecovery() {
  ...
  const submitHandler = (e) => {
    ...
    findPwd(new FormData(e.target), setModalActive);
  };
  return (
    <>
      ...
      <div className={styles.wrapper}>
        <form className={styles.form} onSubmit={submitHandler}>
          <div className={styles.col}>
            <label className={styles.r} name="id" htmlFor="id">
              아이디
            </label>
            <input
              type="text"
